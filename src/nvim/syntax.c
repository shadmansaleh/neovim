...
static int hldict_attr_to_str(dict_T *dict, char_u *key,
                              char_u *attr_str, int len)
{
  dictitem_T  *di;
  dict_T      *attrdict;
  int         i;
...
void f_hlset(typval_T *argvars, typval_T *rettv, FunPtr fptr)
{
  dict_T      *dict;
  ...
  TV_LIST_ITER(argvars->vval.v_list, li, {
    ...
    dict = TV_LIST_ITEM_TV(li)->vval.v_dict;
